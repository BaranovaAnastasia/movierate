...
export const TRAILER_ERROR_MSG = 'Cannot get trailer.';
export const CREDITS_ERROR_MSG = 'Cannot get movie credits.';
export const SEARCH_ERROR_MSG = 'An error occurred while searching.';
export const RATING_ERROR_MSG = 'Cannot get movie rating.';
export const STATS_ERROR_MSG = 'Cannot get movie statistics.';
export const RATE_ERROR_MSG = 'Cannot rate movie.';
export const WATCH_ERROR_MSG = 'Cannot mark movie as watched.';
export const UNWATCH_ERROR_MSG = 'Cannot remove movie from watched.';
...
export const MOVIE_WRITER= 'Writing';
